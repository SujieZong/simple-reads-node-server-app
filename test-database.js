...
console.log(
  `   Stats: ${writerProfile.stats.reviewCount} reviews, ${writerProfile.stats.favoriteCount} favorites\n`
);
...
const readerCanEditOwn = checkUserPermission(
  "user001",
  "user001",
  "edit_own_profile"
);
const readerCanEditOther = checkUserPermission(
  "user001",
  "user002",
  "edit_own_profile"
);
const adminCanEditAny = checkUserPermission(
  "user005",
  "user001",
  "edit_own_profile"
);
...
console.log(
  `   Reader edit other's profile: ${readerCanEditOther ? "✓" : "✗"}`
);
